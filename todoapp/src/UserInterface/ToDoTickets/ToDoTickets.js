...
import './ToDoTickets.css'
import {getMonthName} from '../../DateInfo/Date/DateComponentLogic'
                    ...
                    return (
                        <div 
                            ...
                            <div className='ToDoTickets__CheckPoint'id={id}>
                                <a 
                                    className='CheckPoint__unimportent' 
                                    onClick={addStatus} 
                                    id={id}>
                            ...
                            <div className={elem.classNameTicket} id={id}>
                                <div className='Ticket__item-1'>
                                    <>
                                        <p 
                                            className={elem.classNameText} 
                                            id={elem.id}>{elem.text}
                                        </p>
                                    </>
                                    <>
                                        <span className = 'defaultDate'>
                                            {`${defaultDate} ${month}    ${hours} : ${minutes}`}
                                        </span>
                                    </>
                                </div>
